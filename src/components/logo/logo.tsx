    ...
    >
      <Box
        sx={{
          ...
          alignItems: 'center',
          justifyContent: 'flex-start', // Ensure the icon and text are horizontally aligned
          cursor: 'pointer',
          ...sx,
        }}
      >
        <Iconify
          icon="carbon:tools"
          style={{
            fontSize: single ? 32 : 40,
            marginRight: 8, // Space between icon and text
            color: 'white',
          }}
        />
        <Typography
          variant={single ? 'h6' : 'h5'}
          sx={{
            fontWeight: 700,
            color: 'text.primary',
            whiteSpace: 'nowrap', // Prevent text wrapping
            overflow: 'hidden', // Avoid layout issues
          }}
        >
          ServiceSync
        </Typography>
